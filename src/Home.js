					...
					<div className="pt-12 text-center">
						...
						<div className="relative max-w-6xl mt-16 md:mt-8 mb-8 mx-auto">
							...
							<div className="absolute" style={{ top: "9%", left: "14%", width: "72%", height: "66%" }}>
								<img className="jump rounded wow animate__animated animate__fadeIn" src="/assets/imgs/screen.png" alt="screenshot" />
							</div>
						</div>
					</div>
				</div>
					...
					<div className="relative py-20 px-4 lg:p-20">
						<div className="max-w-lg mx-auto text-center">
							...
							<div className="flex flex-wrap justify-center space-x-4">
								<div className='bg-white p-3 py-2 shadow'>
									<div>Regular price</div>
									<div className="text-gray-700 text-base lg:text-base font-bold font-heading price--line-through">$49</div>
								</div>

								<div className='bg-white p-3 py-2 shadow'>
									<div>Early bird price</div>
									<div className="text-gray-700 text-base lg:text-lg font-bold font-heading price--line-through">$30</div>
								</div>

								<div className='bg-white p-3 py-2 shadow'>
									<div>Your price</div>
									<div className="text-gray-700 text-2xl lg:text-3xl font-bold font-heading">$20</div>
								</div>
							</div>
							...
							<div className="mt-4 p-4 bg-white rounded-lg shadow flex flex-wrap max-w-md mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".5s">
								<div className="flex w-full md:w-2/3 px-3 mb-3 md:mb-0 md:mr-6 bg-blueGray-100 rounded">
									...
									<input {...$username.props} className="w-full pl-3 py-4 text-xs text-blueGray-400 font-semibold leading-none bg-blueGray-100 outline-none" type="text" placeholder="Enter your Twitter handle" />
								</div>

								<button onClick={go} className="w-full md:w-auto py-4 px-8 text-xs text-white font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded" type="submit">
									Sign Up
								</button>
							</div>

							<div className="mt-8 text-gray-400 text-xs wow animate__animated animate__fadeIn" data-wow-delay=".7s">
